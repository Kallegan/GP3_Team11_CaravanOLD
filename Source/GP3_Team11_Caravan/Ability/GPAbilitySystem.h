...
public:	
	...
	void ActivateAbility(float scale, TArray<AActor*> targets, FVector particleSpawnLocation);
	...
	UPROPERTY(Category = "Stat Bonus", EditAnywhere, meta=(EditCondition="bAffectHealth"))
	...
	/*Percentage*/
	UPROPERTY(Category = "Stat Bonus", EditAnywhere, meta=(EditCondition="bAffectSpeed"))
	...
	// Range
	UPROPERTY(Category="Action Ability", EditAnywhere, meta=(EditCondition="bActionAbility"))
	float Range = 300;
